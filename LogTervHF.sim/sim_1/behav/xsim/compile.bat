...
REM
REM Generated by Vivado on Mon May 30 02:08:41 +0200 2022
...
echo "xvlog --incr --relax -prj tb_FFT_Core_vlog.prj"
call xvlog  --incr --relax -prj tb_FFT_Core_vlog.prj -log xvlog.log
