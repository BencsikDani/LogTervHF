...
REM
REM Generated by Vivado on Tue May 31 12:18:06 +0200 2022
...
echo "xvlog --incr --relax -prj tb_square_vlog.prj"
call xvlog  --incr --relax -prj tb_square_vlog.prj -log xvlog.log
